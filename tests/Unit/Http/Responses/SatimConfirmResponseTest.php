...
it('should confirm a card with terminal amount ceiling exceeded', function () {
    $response = SatimConfirmResponse::fromResponse(
        confirmEndpoint([
            ...
            "authCode" => 2,
            "params" => [
                "respCode_desc" => "Votre transaction a été rejetée, Votre plafond a été dépassé, veuillez contacter votre banque. Code erreur :",
                "udf1" => "2018105301346",
                "respCode" => null
            ],
            "actionCode" => "-2006",
            "actionCodeDescription" => "Votre transaction a été rejetée, Votre plafond a été dépassé, veuillez contacter votre banque. Code erreur :",
            "ErrorCode" => "3",
            "ErrorMessage" => "Success",
            "OrderStatus" => "6",
...
it('should confirm an expired card', function () {
    $response = SatimConfirmResponse::fromResponse(
        confirmEndpoint([
            ...
            "authCode" => 2,
            "params" => [
                "respCode_desc" => "Votre transaction a été rejetée, Votre carte a expiré, veuillez contacter votre banque. Code erreur :",
                "udf1" => "2018105301346",
                "respCode" => null
            ],
            "actionCode" => "-2006",
            "actionCodeDescription" => "Votre transaction a été rejetée, Votre carte a expiré, veuillez contacter votre banque. Code erreur :",
            "ErrorCode" => "3",
            "ErrorMessage" => "Order is not confirmed due to order’s state",
            "OrderStatus" => 6,
